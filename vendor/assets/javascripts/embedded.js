// enveloped all of twitter's JS in a custom function, is this too hacky?
function executeTweetFormatter(){
    (function(e, t) {
        function y(e) {
            ...
            using("dom/get", "util/domready", "util/iframe", "util/layout", "util/promise", "util/querystring", "util/typevalidator", "util/util", "tfw/util/globals", "util/logger", function(t, n, r, i, s, o, u, a, f, l) {
                ...
                var c = 0,
                    ...
                    g = {
                        ...
                        bn: {
                            "Follow %{screen_name}": "%{screen_name}-à¦•à§‡ à¦…à¦¨à§à¦¸à¦°à¦£ à¦•à¦°à§à¦¨"
                        },
                        cs: {
                            "Follow %{screen_name}": "Sledovat uÅ¾ivatele %{screen_name}"
                        },
                        da: {
                        ...
                        hi: {
                            ...
                            "Tweet to %{name}": "%{name} à¤•à¥‡ à¤ªà¥à¤°à¤¤à¤¿ à¤Ÿà¥à¤µà¥€à¤Ÿ à¤•à¤°à¥‡à¤‚"
                        },
                        hu: {
                        ...
                        ro: {
                            "Follow %{screen_name}": "UrmÄƒreÅŸte pe %{screen_name}"
                        },
                        ru: {
                        ...
                        uk: {
                            "Follow %{screen_name}": "Ð§Ð¸Ñ‚Ð°Ñ‚Ð¸ %{screen_name}"
                        },
                        ur: {
                        ...
                        vi: {
                            "Follow %{screen_name}": "Theo dÃµi %{screen_name}"
                        },
                        "zh-cn": {
            ...
            using("util/util", "tfw/widget/base", "util/querystring", "util/uri", "util/twitter", "util/promise", "dom/textsize", function(t, n, r, i, s, o, u) {
                ...
                a.prototype = new n, t.aug(a.prototype, {
                    ...
                    render: function(e, n) {
                        ...
                        var r = twttr.widgets.config.assetUrl() + "/widgets/follow_button.1409007440.html#" + this.parameters(),
        ...
        provide("tfw/widget/tweetbutton", function(e) {
            using("tfw/widget/base", "tfw/util/globals", "util/util", "util/querystring", "util/uri", "util/twitter", "util/typevalidator", "dom/textsize", function(t, n, r, i, s, o, u, a) {
                ...
                p.prototype = new t, r.aug(p.prototype, {
                    ...
                    render: function(e, t) {
                        var n = twttr.widgets.config.assetUrl() + "/widgets/tweet_button.1409007440.html#" + this.parameters(),
                            i;
